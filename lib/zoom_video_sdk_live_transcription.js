...
export default (function () {
  ...
  function init (opts) {
    ...
    return {
       ...
       * @return {Boolean} True if the user can start live transcription, otherwise false.
       */
       ...
       *   - {Number} status - The current live transcription status, {@link ZoomVideoSDKLiveTranscriptionStatus} enum.
       */
       ...
       * @return {Array} If the function succeeds, returns an array of language objects with the following members:
       *   - {Number} lttLanguageID - The ID of the language
       *   - {String} lttLanguageName - The name of the language
       ...
       * @return {Object} If the function succeeds, returns a language object with the following members:
       *   - {Number} lttLanguageID - The ID of the language
       *   - {String} lttLanguageName - The name of the language
       *   Otherwise returns ZoomVideoSDKErrors error code.
       */
