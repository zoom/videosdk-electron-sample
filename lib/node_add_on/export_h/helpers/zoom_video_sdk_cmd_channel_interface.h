...
public:
     ...
     * @param receiver The user who receives the command, if receiver is set to nullptr, the command is broadcast to all users.
     * @param strCmd The custom commands or data.
	 * @return If the command sends successfully, the return value is ZoomVideoSDKErrors_Success. Otherwise the send command request fails.
	 */
