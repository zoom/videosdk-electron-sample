...
public:
	 ...
	 * @param timerInterval Usually the SDK sends the mic and speaker volumes every 200 ms by default via ITestAudioDeviceHelperEvent::onMicSpeakerVolumeChanged(). With this function, the user can modify the time interval instead of 200. Accepted values between 50 to 1000 milliseconds.
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise failed.  
