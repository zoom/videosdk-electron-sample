...
public:
     ...
     * @return The dial in number is account dedicated number or not .
     */
...
public:
	 ...
	 * @return If the function succeeds, the method returns the PhoneStatus of the invitation by phone.
	 */
	virtual PhoneStatus getInviteByPhoneStatus() = 0;
	
	/**
	 * @brief Get the list of dial in numbers supported by session.
	 * @return If the function succeeds, the return value is the list of the dial-in numbers. Otherwise failed.
	 */
