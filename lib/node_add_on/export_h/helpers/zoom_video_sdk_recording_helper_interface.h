...
public:	
	 ...
	 * @return ZoomVideoSDKErrors_Success if the current user meets the requirements to start cloud recording. Otherwise, the current user does not meeting the requirements to start recording.
	 */
	 ...
	 * @return ZoomVideoSDKErrors_Success if the start cloud recording request was successful. Otherwise, the start cloud recording request failed.  
	 */
	 ...
	 * @return ZoomVideoSDKErrors_Success if the pause cloud recording request was successful. Otherwise, the pause cloud recording request failed.  
	 */
	 ...
	 * @return ZoomVideoSDKErrors_Success if the resume cloud recording request was successful. Otherwise, the resume cloud recording request failed.  
	 */
	 ...
	 * @return ZoomVideoSDKErrors_Success if the get cloud recording status request was successful. Otherwise failed. the get cloud recording status request failed.  
	 */
