...
public:
	 ...
	 * @param rawdata_sender You can send audio data based on this object.
	 */
...
public:
	 ...
	 * @param data_ The mixed audio raw data. A pointer to AudioRawData.
	 */
	 ...
	 * @param data_ The one way audio raw data. A pointer to AudioRawData.
	 ...
	 * @param data_ The shared audio raw data in session. A pointer to AudioRawData.
	 */
