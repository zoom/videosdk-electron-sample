...
import { setUserInfo, getUserInfo } from './zoom_video_sdk_user_util.js'
  ...
  function init (opts) {
    ...
    return {
      ...
      */
       ...
       * @return {Boolean} Returns true if the rotation was successful, false otherwise.
       */
       ...
       * @method switchCamera
       * @return {Boolean} Returns true if the switch to the next camera was successful, false otherwise.
       */
      ...
      /**
       * Returns a collection of camera devices available to share the video.
       * @method getCameraList
       * @return {Array} Camera devices list containing:
       *   - deviceID: The camera device ID
       *   - deviceName: The camera device name
       *   - isSelectedDevice: Whether the camera is the selected device
       */
       ...
       * @param {Number} range Rotation range, 10 <= range <= 100.
       * @return {Number} If the function succeeds, the return value is ZoomVideoSDKErrors_Success.
       */
       ...
       * Zoom the camera in.
       * @method zoomCameraIn
       * @param {Number} range Zoom range, 10 <= range <= 100.
       * @return {Number} If the function succeeds, the return value is ZoomVideoSDKErrors_Success.
       */
       ...
       * @param {String} cameraDeviceID The camera device ID.
       * @return {Number} If the function succeeds, the return value is ZoomVideoSDKErrors_Success.
       */
       ...
       * @param {Number} vbItemHandle The choosing virtual background item handle.
       * @return {Object} If the function succeeds, the return value is VirtualBackgroundItem object containing:
       *   - imageFilePath: Current item image file path
       *   - imageName: Current item image name
       *   - vbType: Current item background type
       *   - canBeDeleted: Whether the virtual background can be deleted
