...
export default (function () {
  ...
  function init (opts) {
    ...
    return {
       ...
       * @param {Number} captureMode The mode to be set, {@link ZoomVideoSDKScreenCaptureMode} enum.
       ...
       *   - {Number} captureMode - The screen capture mode {@link ZoomVideoSDKScreenCaptureMode} enum.
       */
       ...
       * @return {Number} If the function succeeds, the return value is ZoomVideoSDKErrors_Success.
       * @note This interface is only available on Windows platform.
       */
