...
const ZoomVideoSDKErrors = {
  ...
  ZoomVideoSDKErrors_Session_Share_Camera_Video_Not_Start: 7010,
  ZoomVideoSDKErrors_Session_Share_Camera_Conflict_With_Video_Effects: 7011,
...
const ZoomVideoSDKCallback = {
  ...
  /** 52, Notify that the camera list has changed. */
  onCameraListChanged: 52,
  /** 53, Invoked when a user makes changes to their share content type, such as camera share switch to normal share. The share type can be found in {@link ZoomVideoSDKShareType}. */
  onShareContentChanged: 53,
  /** 54, Invoked when the share content size has changed. */
  onShareContentSizeChanged: 54,
  /** 55, Receive this callback when call 'startShareWithPreprocessing' successfully. */
  onCapturedRawDataReceived: 55,
  /** 56, Receive this callback when call 'stopShare' successfully. */
...
const ZoomVideoSDKShareType = {
  ...
  /** 1, application or desktop share */
  ZoomVideoSDKShareType_Normal: 1,
  /** 2, pure computer audio share */
...
const ZoomVideoSDKSharePreprocessType = {
  ...
  /** 1, For share screen(monitor). */
  ZoomVideoSDKSharePreprocessType_screen: 1,  
  /** 2, For share view(application window). */
...
const ZoomVideoSDKAnnotationClearType = {
  ...
  ZoomVideoSDKAnnotationClearType_All: 0,///<Clear all annotations.
  /** 1, Clear only the others' annotations. */
  ZoomVideoSDKAnnotationClearType_Others: 1,
  /** 2, Clear only your own annotations. */
