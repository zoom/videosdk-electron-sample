...
export default (function () {
  ...
  function init (opts) {
    ...
    return {
      ...
      startShareWithPreprocessing: function (opts) {
        if (_addon) {
          ...
          try {
            ...
            const handle = clientOpts.handle
            const monitorID = clientOpts.monitorID
            if (type != ZoomVideoSDKSharePreprocessType.ZoomVideoSDKSharePreprocessType_screen
                && type != ZoomVideoSDKSharePreprocessType.ZoomVideoSDKSharePreprocessType_view) {
              return ZoomVideoSDKErrors.ZoomVideoSDKErrors_Invalid_Parameter
            }
      ...
      * @param {Array} buffer rawdata buffer
      ...
      */
       ...
       * @return {ZoomSDKError} If the function succeeds, the return value is ZoomVideoSDKErrors_Success.
       Otherwise, failed. To get extended error information, {@link ZoomVideoSDKErrors} enum.
       */
